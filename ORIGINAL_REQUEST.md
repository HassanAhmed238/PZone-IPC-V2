...
## Initial Request — 2026-06-10T14:40:07+03:00
...
### Correctness
- [x] Draft invoices can be saved and synced without colliding or overwriting each other.
- [x] The app recovers and retries Supabase database connections for `ipc_projects` after a 5-minute TTL.
- [x] Obsolete RPC calls are removed and compilation passes.

### Performance
- [x] Filter changes are memoized, and `useFinancialSnapshot` does not recalculate unless filter values actually change.
